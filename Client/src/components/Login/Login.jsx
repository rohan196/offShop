  ...
  return (
        <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
          ...
          <div className="md:w-1/3 max-w-sm bg-slate-300 rounded-3xl p-6 h-[350px]">
            ...
            {/* <a className="text-red-600 hover:underline hover:underline-offset-4" href="#">Register</a> */}
            <Link to = "/register" className={" "+(current=="/register"?"text-red-600 hover:underline hover:underline-offset-4":"")}> Register </Link>
            </div>
            {/* <div className="mt-32 w-full">
              <Link to = "/" className={" "+(current=="/"?"text-red-600 hover:underline hover:underline-offset-4":"")}> Home </Link>
            </div> */}
          </div>
        </section>
      )
