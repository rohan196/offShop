  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:h-[82vh] lg:bg-[#F2F0F1]">
      ...
      <div className="top flex flex-col px-3  lg:h-full justify-center lg:w-[700px]">
        ...
        <Link to="/shoppingPage" className={" " + (current == "/shoppingPage" ? "text-blue-500" : "")}>
        <div className="shopNowButton  rounded-full bg-black text-white py-3 mt-4 px-4 flex justify-center lg:w-[200px] hover:bg-gray-500 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
        <h2>Shop Now</h2>
        </div>
        </Link>
